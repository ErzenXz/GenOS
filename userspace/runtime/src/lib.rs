...
pub use genos_abi::{
    ...
    USER_FILE_WRITE_MAX as FILE_WRITE_MAX, USER_INPUT_KIND_KEY as INPUT_KIND_KEY,
    ...
    USER_PING_REPLY as PING_REPLY, USER_POINTER_BUTTON_LEFT as POINTER_BUTTON_LEFT,
