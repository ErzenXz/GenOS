...
pub const USER_ABI_VERSION: u64 = 18;
...
pub const USER_SYSCALL_SOCKET_WAIT: u64 = 48;
...
pub const USER_SOCKET_READY_MASK: u64 = USER_SOCKET_READY_READABLE
    | USER_SOCKET_READY_WRITABLE
    | USER_SOCKET_READY_CONNECTED
    | USER_SOCKET_READY_CLOSED
    | USER_SOCKET_READY_ERROR
    | USER_SOCKET_READY_ACCEPT;
pub const USER_SOCKET_WAIT_MAX_TICKS: u64 = 10_000;
...
pub const USER_ERROR_TIMED_OUT: u64 = u64::MAX - 4;
