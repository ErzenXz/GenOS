use genos_abi::{
    ...
    USER_ERROR_TIMED_OUT, USER_ERROR_UNAVAILABLE, USER_ERROR_UNKNOWN_SYSCALL,
    USER_ERROR_WOULD_BLOCK, USER_EXECUTABLE_PAGE_CAPACITY, USER_FILE_HANDLE_CAPACITY,
    USER_FILE_KIND_DIRECTORY, USER_FILE_KIND_REGULAR, USER_FILE_READ_MAX, USER_FILE_RIGHTS_MASK,
    USER_FILE_RIGHT_MANAGE, USER_FILE_RIGHT_READ, USER_FILE_RIGHT_WRITE, USER_FILE_WRITE_MAX,
    USER_IMAGE_LAYOUT_VERSION, USER_INPUT_KIND_KEY, USER_INPUT_KIND_POINTER_BUTTON,
    ...
    USER_POINTER_BUTTON_RIGHT, USER_SOCKET_BUFFER_CAPACITY, USER_SOCKET_HANDLE_CAPACITY,
    USER_SOCKET_LISTENER_BACKLOG_CAPACITY, USER_SOCKET_LISTENER_PORT_MIN,
    USER_SOCKET_PROTOCOL_TCP_STREAM, USER_SOCKET_PROTOCOL_UDP, USER_SOCKET_READY_ACCEPT,
    USER_SOCKET_READY_MASK, USER_SOCKET_SHUTDOWN_BOTH, USER_SOCKET_STATE_BOUND,
    USER_SOCKET_STATE_CONNECTING, USER_SOCKET_STATE_LISTENING, USER_SOCKET_WAIT_MAX_TICKS,
    USER_SYSCALL_CLOSE_ENDPOINT, USER_SYSCALL_CONNECT_ENDPOINT, USER_SYSCALL_CONSOLE_CLEAR,
    USER_SYSCALL_CONSOLE_SET_INPUT, USER_SYSCALL_CONSOLE_WRITE, USER_SYSCALL_CREATE_DIRECTORY,
    USER_SYSCALL_CREATE_ENDPOINT, USER_SYSCALL_NETWORK_CONFIG, USER_SYSCALL_PROCESS_KILL,
    USER_SYSCALL_PROCESS_LAUNCH, USER_SYSCALL_PROCESS_REAP, USER_SYSCALL_PROCESS_STATUS,
    USER_SYSCALL_RECEIVE_ENDPOINT, USER_SYSCALL_REMOVE_PATH, USER_SYSCALL_SEND_ENDPOINT,
    USER_SYSCALL_SOCKET_ACCEPT, USER_SYSCALL_SOCKET_BIND, USER_SYSCALL_SOCKET_CLOSE,
    USER_SYSCALL_SOCKET_CONNECT, USER_SYSCALL_SOCKET_LISTEN, USER_SYSCALL_SOCKET_OPEN,
    USER_SYSCALL_SOCKET_RECEIVE, USER_SYSCALL_SOCKET_SEND, USER_SYSCALL_SOCKET_SHUTDOWN,
    USER_SYSCALL_SOCKET_STATUS, USER_SYSCALL_SOCKET_WAIT, USER_SYSCALL_TCP_EXCHANGE,
    USER_SYSCALL_TRUNCATE_HANDLE, USER_SYSCALL_UDP_EXCHANGE, USER_TIMER_HZ, USER_WRITABLE_PREFIX,
};
...
fn nonblocking_socket_contract_is_stable() {
    ...
    assert_eq!(USER_SOCKET_READY_MASK, 63);
    assert_eq!(USER_SOCKET_WAIT_MAX_TICKS, 10_000);
    ...
    assert_eq!(USER_ERROR_TIMED_OUT, u64::MAX - 4);
    assert_eq!(USER_SYSCALL_SOCKET_WAIT, 48);
