use genos_abi::{
    ...
    USER_ABI_VERSION, USER_CHANNEL_MESSAGE_SIZE, USER_CONSOLE_LINE_ERROR, USER_CONSOLE_LINE_OUTPUT,
    ...
    USER_FILE_RIGHT_READ, USER_FILE_RIGHT_WRITE, USER_FILE_WRITE_MAX, USER_INPUT_KIND_KEY,
